...
TIME_WINDOW_S = 0.5   # set None to disable cropping

simulation_data_path = "/home/shenji/uav_payload_lab/uav_payload_lab/logs/rsl_rl/Encoder_DataCollection/Oracle_MLW_Hori/payload_data.csv" 
