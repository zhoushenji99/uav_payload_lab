...
def main():
    ...
    ap.add_argument("--start", type=float, nargs=3, default=[0.0, 0.0, 2.0], help="TASK start offset (x y z)")
    ap.add_argument("--goal", type=float, nargs=3, default=[4.0, 0.0, 2.0], help="TASK goal offset (x y z)")
